...
const PasswordReset = () => {
    ...
    <div className="flex justify-center items-center h-screen bg-dark dark:bg-neutral-900">
        <div className="bg-white dark:bg-neutral-800 shadow-md rounded-lg px-8 py-6 w-full sm:max-w-md">
            <h2 className="text-xl font-semibold mb-4 text-gray-700 dark:text-white">Password Reset</h2>
